...
function page_tag(total, row, col, now){
	...
	if(total>row){
		...
		txt +="<ul>";
			if(!(now_col_index<=1)){
				txt +="<li class='paging_img'> <a href='#'  onclick='goPage(" + 1 +")'><img src='/images/admin/btn_first.gif'alt=''  width='19px' height='19px'/></a></li>";
				txt +="<li class='paging_img'> <a href='#'  onclick='goPage(" + (parseInt(now)-10) +")'><img src='/images/admin/btn_prev.gif'alt='' /></a></li>";
			}
			...
			if(total > now_col_index_end*row){
				txt +="<li class='paging_img'> <a href='#'  onclick='goPage(" + (parseInt(now)+10) +")'><img src='/images/admin/btn_next.gif'alt='' /></a></li>";
				if(( parseInt(total_col) - parseInt(now) )> 10){
					txt +="<li class='paging_img'> <a href='#'  onclick='goPage(" + last +")'><img src='/images/admin/btn_last.gif'alt='' width='19px' height='19px'/></a></li>";
				}
