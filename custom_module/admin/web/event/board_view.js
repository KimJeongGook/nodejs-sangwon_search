...
exports.listener=function(request, response){
	 ...
	 var sql = "select " +
			   ...
			   " (select ad_nm from admin where ad_id = a.create_id) as create_name, a.sort, \n" +
			   " a.strt_dt, a.end_dt \n" +
		 	   " from "+table+" a where a.board_no = " + brd_no;
	 console.log(sql);
	 ...
	 fs.readFile("./views/admin/web/event/board_view.html", "utf-8", function(error, data){
		 async.series({
