...
exports.listener=function(request, response){
	...
	switch (category) {
		case 'notice':
			sql = "select " +
				" board_no, board_id, board_cnt, board_title, board_content, create_id,link1,link2,link3, date_format(create_date, '%Y-%m-%d') as c_date, create_host, \n" +
				" (select b.ad_nm from admin b where b.ad_id = a.create_id) as create_name, a.sort \n" +
