...
exports.listener=function(request, response){
	 ...
	 var sql = "select " +
			   " board_no, board_id, board_cnt, board_title, board_content, board_startdate, board_enddate, board_eventsdate, board_eventedate, board_address,board_address_detail,   create_id, date_format(create_date, '%Y-%m-%d') as c_date, create_host, \n" +
			   " (select b.create_id from admin_mngt b where b.ad_id = a.create_id) as create_name, a.sort \n" +
