...
exports.listener=function(request, response){
	...
	var link3 =  request.param("link3") == undefined ? "" : request.param("link3");
	...
	console.log("brd_title == " + brd_title);
	console.log("brd_title.length == " + brd_title.length);
	console.log("brd_titleByteLength == " + brd_titleByteLength);
	
	if(brd_titleByteLength>80) {
		var str = brd_title;
		var l = 0;
		var len = 70;
		var substring_str = "";
		...
		/*for (var i=0; i<str.length; i++) {
	       ...
	       if (l > len) {
	    	   console.log("i == " + i);
	    	   substring_str = str.substring(0,i);
	       }
	       console.log("l == " + l);
		}*/
		substring_str = brd_title.substring(0, 70);
		console.log("substring_str == " + substring_str);
		substring_str = substring_str + "...";
		console.log("substring_str == " + substring_str);
	}
	...
	if(mode=="write"){
		sql = "insert into "+board_table+"(" +
				"board_id, board_title, board_content, sort,link1,link2,link3, " +
							...
							db.query(select_sql, function(error, brd_no){
								if(error){
									...
									if(brdPushYn_result == "Y"){
										...
										db.query(push_sql, function(error, results2){
